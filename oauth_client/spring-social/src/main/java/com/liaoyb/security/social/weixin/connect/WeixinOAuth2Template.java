...
/**
 * qq获取accessToken返回的类型是text/html(需要自定义解析)
 *
 * @author zhailiang
 */
@Slf4j
public class WeixinOAuth2Template implements OAuth2Operations {
    ...
    public AccessGrant exchangeCredentialsForAccess(String username, String password, MultiValueMap<String, String> additionalParameters) {
        throw new RuntimeException("微信登录不支持密码模式");
    }
    ...
    public AccessGrant authenticateClient(String scope) {
        throw new RuntimeException("微信登录不支持客户端模式");
    }
